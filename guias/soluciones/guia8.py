...
class implementacionesGuia8:
    # Ejercicio 1. 
    # Codificar en Python las siguientes funciones sobre secuencias

    # 1.1
    def pertenece(self, l :list, e: int) -> bool:
        if e in l:
            return True
        else:
            return False
    ...
    # 1.4
    def ordenados(self, s: list[int]) -> bool:
    ...
    # 1.5
    def es_palabra_mayor_a_7(l: list[str]) -> bool:
        for i in l:
            if len(i) > 7:
                return True
        return False
    ...
    #Ejercicio 4
    #4.1
    def perteneceACadaUno(self, l: list[list[int]], elem: int):
        res: list[bool] = []
        for sublista in l:
            if self.pertenece(sublista, elem) == True:
                res.append(True)
            else:
                res.append(False)
        print(res)
    ...
    def esMatriz(s: list[list[int]]) -> bool:
        ...
        return True
    #4.3
    def filasOrdenadas(self, m: list[list[int]]):
        res: list[bool] = []
        for i in m:
            if self.ordenados(i) == True:
                res.append(True)
            else:
                res.append(False)
        print(res)
